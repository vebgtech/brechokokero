...
<section id="contact" class="contact">
  <div class="container" data-aos="fade-up">
    <div id="col-lg-8">
      ...
      <form action="../controller/processar-cadastro.php" method="POST" enctype="multipart/form-data" role="form" class="php-email-form">
        <h1>Cadastro</h1>
        ...
        <div class="text-center p-t-115">
          ...
          <a class="txt2" href="log.php">Faça seu login!</a>
        </div>
