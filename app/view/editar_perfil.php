    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <ul class="navbar-nav d-flex flex-row">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" data-bs-toggle="offcanvas" data-bs-target="#carrinhoOffcanvas">
...
<div class="container py-5">
    <div class="edit-profile-container">
        ...
        <div class="mb-4">
            <a href="minha_conta.php" class="back-link">
        ...
        <?php else: ?>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-success">R$ <?php echo number_format($p['preco'], 2, ',', '.'); ?></div>
                    </div>
                </div>
                <form method="POST" action="../controller/remover_carrinho.php" class="m-0">
            ...
            <div class="border-top pt-3 mt-3">
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <div class="text-success fw-bold">R$ <?php echo number_format($total, 2, ',', '.'); ?></div>
                </div>
